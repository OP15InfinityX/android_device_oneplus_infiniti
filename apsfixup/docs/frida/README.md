...
- Offsets inside these scripts are pinned to the infiniti blobs (libAlgoProcess `627697fe…`,
  libAlgoInterface `3704ddad…`). On a new blob, update them the same way as the native lib
