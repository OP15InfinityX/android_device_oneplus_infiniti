...
4. Soong namespace: the blob namespace (`vendor/<oem>/<device>`) must `import` the namespace that
   defines `libapsfixup` (here `device/oneplus/infiniti`) — add it to `namespace_imports`.
...
- Offsets here are for: libAlgoProcess `BuildId 627697fe478fe6eb6203f368c5758180`, libAlgoInterface
  `BuildId 3704ddadaa3b8308302843fcc6d6c486` (OnePlus 15 / infiniti, sm8850). Verify BuildIds with
